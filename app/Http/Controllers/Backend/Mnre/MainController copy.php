...
class MainController extends Controller
{
    ...
    public function viewApplication(Request $request, $id)
    {
        ...
        /*************************Audit Trail Start**********************************/
        return view('backend.mnre.view-applications', compact('applicationDetail','applied_pvmodels','annexure1','annexure1_sub2','annexure1_sub3',
        'annexure1_sub4','annexure1_sub5','annexure1_sub6','annexure6','annexure5_appData','annexure5_lfyappData','annexure5_ltlfyappData','annexure2_aryData',
        'annexure3','annexure4','annexure4_sub3','annexure4_sub4','annexure4_sub5'));
    }
