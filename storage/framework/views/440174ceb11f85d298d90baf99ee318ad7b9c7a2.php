                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="box-body">
                            ...
                            <form action="<?php echo e(URL::to('/users/new-application')); ?>" method="POST"
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <select name="country" id="country">
                                                        ...
                                                        <option value="<?php echo e($country->countrycd); ?>" <?php if(!Empty($appData->country) && $appData->country==$country->countrycd): ?> selected <?php endif; ?> ><?php echo e($country->name); ?></option>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <tr>
                                        <th colspan="3">
                                            ...
                                            <a href="<?php echo e(URL::to('users/new-application-step2/'.$appData->id)); ?>"
    ...
    <?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.masters.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\almm\resources\views/backend/user/form/newApplication.blade.php ENDPATH**/ ?>