                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="box-body">
                            ...
                            <form action="<?php echo e(URL::to('/users/annexure-eight')); ?>" method="POST"
                                        ...
                                        <th>
                                            <div class="row">
                                                <div class="col-md-6 col-md-offset-3">
                                                    ...
                                                    <?php if(isset($appData) && $appData->annexure8!=null): ?>
                                                    <i style="display: inline-block;float: right;"><a
                                                            href="<?php echo e(URL::to($docBaseUrl.$appData->annexure8)); ?>"
                                                            style="margin-top: -8px;display: block;"
                                                            target="_blank">View
                                                            uploaded Annexure</a></i>
                                                    <?php endif; ?>
                                                    <?php $__errorArgs = ['annexure8'];
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="col-md-6 col-md-offset-3"><br>
                                                    <input type="submit" name="submit"
                                                        value="<?php if(isset($appData->id) && $appData->annexure8!=null): ?>Update <?php else: ?> Upload <?php endif; ?>"
                                                        class="btn btn-success" id=""><br>
                                                    <small style="color:blue"><i>Please download the annexure form 8
                                                            and
                                                            upload duly signed
                                                            copy (<a
                                                                href="<?php echo e(URL::asset('public/downloadables/Annexure8.pdf')); ?>"
...
<?php echo $__env->make('layouts.masters.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\almm\resources\views/backend/user/form/annexureEight/annexureEight.blade.php ENDPATH**/ ?>