    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            ...
            <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li><a href="#"><i class="bi bi-circle"></i>Help Documents</a></li>
                <li><a href="#"><i class="bi bi-circle"></i>Annexures</a></li>
                <li><a href="<?php echo e(URL::to('/'.Auth::getDefaultDriver().'/application-fee-master')); ?>"><i class="bi bi-circle"></i>Fee details</a></li>
                <li><a href="#"><i class="bi bi-circle"></i>Approved lists I & II</a></li>
...
<?php /**PATH D:\xamp\htdocs\ALMM\resources\views/layouts/partials/backend/_sidebar.blade.php ENDPATH**/ ?>