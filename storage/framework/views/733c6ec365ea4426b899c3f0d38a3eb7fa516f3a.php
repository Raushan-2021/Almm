    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            ...
            <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li><a href="#"><i class="bi bi-circle"></i>Help Documents</a></li>
                <li><a href="#"><i class="bi bi-circle"></i>Annexures</a></li>
                <li><a href="<?php echo e(URL::to('/'.Auth::getDefaultDriver().'/application-fee-master')); ?>"><i
        ...
        <li class="nav-item">
            ...
            <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                ...
                <li><a href="<?php echo e(URL::to('/users/new-application')); ?>"><i class="bi bi-circle"></i>New
                        Application</a></li>
                <li><a href="<?php echo e(URL::to('/users/select-exising-application')); ?>"><i class="bi bi-circle"></i>PV
...
</aside><?php /**PATH C:\xampp\htdocs\almm\resources\views/layouts/partials/backend/_sidebar.blade.php ENDPATH**/ ?>