<head>
    <title>ALMM | <?php echo $__env->yieldContent('title'); ?></title>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('public/css/bootstrap-datepicker.min.css')); ?>">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('public/backend/css/animations.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('public/backend/css/bootstrap-icons.css')); ?>" />

    <link rel="icon" type="image/png" sizes="32x32" href="images/favicon.png">
    <link rel="icon" type="image/png" sizes="16x16" href="images/favicon.png">
    <?php echo $__env->yieldPushContent('backend-css'); ?>
</head>
<?php /**PATH C:\xampp\htdocs\almm\resources\views/layouts/partials/backend/_head.blade.php ENDPATH**/ ?>