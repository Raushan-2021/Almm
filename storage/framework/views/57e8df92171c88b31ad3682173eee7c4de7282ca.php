<header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
        <a href="<?php echo e(URL::to('/'.Auth::getDefaultDriver())); ?>" class="logo d-flex align-items-center">
            ...
            <li class="nav-item dropdown pe-3">
                ...
                <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                    ...
                    <span class="d-none d-md-block dropdown-toggle ps-2"><small
                            class="welcomeUser">Welcome</small><?php echo e(Auth::user()->name); ?></span>
                </a>
                ...
                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="<?php echo e(URL::to('/users/edit-profile')); ?>">
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="<?php echo e(URL::to('/users/change-password')); ?>">
...
<?php /**PATH C:\xampp\htdocs\almm\resources\views/layouts/partials/backend/_header.blade.php ENDPATH**/ ?>