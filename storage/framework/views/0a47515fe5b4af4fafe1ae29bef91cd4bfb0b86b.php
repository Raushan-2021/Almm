...
<div class="row">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="box-body">
                            ...
                            <?php endif; ?>
                            <form action="<?php echo e(URL::to('/users/existing-annexure-one-b')); ?>" method="POST"
                                ...
                                <table class="table table-bordered" id="show_data"
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <a href="<?php echo e(URL::to('users/existing-annexure-one-b/'.$application_id)); ?>"
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                <a
                                                    href="<?php echo e(URL::to('users/existing-annexure-one-b/'.$data->application_id.'/'.$data->id)); ?>">Edit
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <th colspan="14">
                                            ...
                                            <?php endif; ?>
                                            <a href="<?php echo e(URL::to('users/existing-annexure-one/'.$application_id)); ?>"
    ...
    <?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.masters.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\almm\resources\views/backend/user/existingmodel/annexureOne/existingannexure1_2.blade.php ENDPATH**/ ?>