          ...
          <div class="row">
            ...
            <div class="col-xxl-3 col-md-6 col-sm-6 col-12 pb-4">
              <div class="col-xxl-12 report_summary blk1">
                ...
                <p class="name">Inspections Assigned</p>
                <p class="num"><?php echo e($data['inspections_assigned']); ?></p>
              </div>
            </div>
...
<?php echo $__env->make('layouts.masters.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\almm\resources\views/backend/user/dashboard.blade.php ENDPATH**/ ?>