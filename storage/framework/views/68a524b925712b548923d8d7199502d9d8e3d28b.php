            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="box-body">
                            <form action="<?php echo e(URL::to('/users/new-application-step2')); ?>" method="POST"
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input type="text" name="manufacturing_capacity"
                                                        ...
                                                        value="<?php echo e(old('manufacturing_capacity') ?? $appData->manufacturing_capacity); ?>">
                                                ...
                                                <div class="row col-md-12 enlistData  <?php if(isset($appData->enlisted_almm) && $appData->enlisted_almm
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="number" name="no_enlisted_pvmodel"
                                                            ...
                                                            value="<?php echo e(old('no_enlisted_pvmodel') ?? $appData->no_enlisted_pvmodel); ?>">
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="number" name="total_pv_capacity"
                                                            ...
                                                            class="form-control"
                                                            value="<?php echo e(old('total_pv_capacity') ?? $appData->total_pv_capacity); ?>">
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="date" name="validity_from" id="validity_from"
                                                            class="form-control"
                                                            value="<?php echo e(old('validity_from') ?? $appData->validity_from); ?>"><br>
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="date" name="validity_to" id="validity_to"
                                                            class="form-control"
                                                            value="<?php echo e(old('validity_to') ?? $appData->validity_to); ?>"><br>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td width="20%"> <strong>Details of Payment of Fee <small
                                                    class="text-danger">*</small></strong>
                                            <br><br><br><br><br>
                                            <small> <i>Attach Payment Proof as attachment No. 2</i> </small>
                                        </td>
                                        <td>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="number" name="application_fees" step="any"
                                                        ...
                                                        value="<?php echo e(old('application_fees') ?? $appData->application_fees); ?>">
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="number" name="inspection_fees" step="any"
                                                        ...
                                                        value="<?php echo e(old('inspection_fees') ?? $appData->inspection_fees); ?>">
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="number" name="total_amount" id="total_amount" min="0"
                                                        ...
                                                        value="<?php echo e(old('total_amount') ?? $appData->total_amount); ?>">
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="date" name="payment_date" id="payment_date"
                                                        class="form-control"
                                                        value="<?php echo e(old('payment_date') ?? $appData->payment_date); ?>"><br>
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" name="utn_no" id="utn_no" class="form-control"
                                                        value="<?php echo e(old('utn_no') ?? $appData->utn_no); ?>">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input type="date" name="inspection_date" id="inspection_date"
                                                        ...
                                                        value="<?php echo e(old('inspection_date') ?? $appData->inspection_date); ?>">
...
<?php echo $__env->make('layouts.masters.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\ALMM\resources\views/backend/user/form/newApplicationStep2.blade.php ENDPATH**/ ?>