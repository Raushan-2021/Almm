...
<?php $__env->startSection('title', 'Applications Detail : '.$annexureData['applicationDetail']['application_no']); ?>
<?php $docBaseUrl ='users/preview-docs/Annexure/';
$attchmentBaseUrl ='users/preview-docs/Attachment/';
?>
<div class="box box-primary">
    <div class="box-body">
        <div class="row">
            ...
            <div class="col-md-12">
                <a href="<?php echo e(url('/users/user-applications')); ?>" class="btn btn-warning" style="float:right">Back</a>
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <th>
                            <?php if($annexureData['applicationDetail']['application_type']==1): ?>
                            <i>New Application</i>
                            <?php elseif($annexureData['applicationDetail']['application_type']==2): ?>
                            PV Model Addition at
                            the existing manufacturing facility>
                            <?php elseif($annexureData['applicationDetail']['application_type']==3): ?>
                            Application for new
                            manufacturing facility
                            <?php elseif($annexureData['applicationDetail']['application_type']==4): ?>
                            Renewal
                            <?php elseif($annexureData['applicationDetail']['application_type']==5): ?>
                            Co-ALMM
                            <?php endif; ?>
                        </th>
                    </tr>
                    <tr>
                        ...
                        <th>
                            <div class="row">
                                <div class="col-md-6">
                                    <?php echo e($annexureData['applicationDetail']['manufacturer_name']); ?>
                    ...
                    <tr>
                        ...
                        <th>
                            <div class="row">
                                <div class="col-md-4">
                                    <?php echo e($annexureData['applicationDetail']['manufacturer_brand_name']); ?>
                                ...
                                <div class="col-md-8">
                                    <img src="<?php echo e(url('storage/systems/Logo/'.$annexureData['applicationDetail']['manufacturer_brand_logo'])); ?>"
                                        width="100">
                                </div>
                    ...
                    <tr>
                        ...
                        <th>
                            ...
                            <?php echo e($annexureData['applicationDetail']['register_office_address']); ?>

                            <div class="row">
                                <div class="col-md-6">
                                    <label for="phone">Phone:</label>
                                    <?php echo e($annexureData['applicationDetail']['register_office_phone']); ?>

                                </div>

                                <div class="col-md-6">
                                    <label for="email">Email:</label>
                                    <?php echo e($annexureData['applicationDetail']['register_office_email']); ?>
                    ...
                    <tr>
                        ...
                        <th>
                            <label for="">Address:</label>
                            <?php echo e($annexureData['applicationDetail']['com_address']); ?>

                            <div class="row">
                                <div class="col-md-6">
                                    <label for="phone">Phone:</label>
                                    <?php echo e($annexureData['applicationDetail']['com_phone']); ?>

                                </div>
                                <div class="col-md-6">
                                    <label for="email">Email:</label>
                                    <?php echo e($annexureData['applicationDetail']['com_email']); ?>
                    ...
                    <tr>
                        ...
                        <th>
                            <?php echo e($annexureData['applicationDetail']['plant_address']); ?>

                            <div class="row">
                                <div class="col-md-6">
                                    <label for="phone">Phone:</label>
                                    <?php echo e($annexureData['applicationDetail']['plant_phone']); ?>

                                </div>
                                <div class="col-md-6"><label for="email">Email:</label>
                                    <?php echo e($annexureData['applicationDetail']['plant_email']); ?>

                                </div>
                                <div class="col-md-6">
                                    <label for="">Latitude:</label>
                                    <?php echo e($annexureData['applicationDetail']['plant_latitude']); ?>

                                </div>
                                <div class="col-md-6">
                                    <label for="Longitude">Longitude:</label>
                                    <?php echo e($annexureData['applicationDetail']['plant_longitude']); ?>
                        ...
                        <td>
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <?php echo e($annexureData['applicationDetail']['existing_plant_india']); ?>

                                </div>
                                <div class="col-md-6">
                                    <label for="">No. of Manufacturing plant out of India:</label>
                                    <?php echo e($annexureData['applicationDetail']['existing_plant_outindia']); ?>
                        ...
                        <td>
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <?php echo e($annexureData['applicationDetail']['contact_person_name']); ?>

                                </div>
                                <div class="col-md-6">
                                    <label for="">Designation:</label>
                                    <?php echo e($annexureData['applicationDetail']['person_designation']); ?>

                                </div>

                                <div class="col-md-6">
                                    <label for="">Phone No:</label>
                                    <?php echo e($annexureData['applicationDetail']['person_contact_no']); ?>

                                </div>

                                <div class="col-md-6">
                                    <label for="">E-mail:</label>
                                    <?php echo e($annexureData['applicationDetail']['person_email']); ?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="col-md-4">
                                    <label for="">Name:</label>
                                    <?php echo e($annexureData['applicationDetail']['authorize_name']); ?>

                                </div>

                                <div class="col-md-4">
                                    <label for="">Designation:</label>
                                    <?php echo e($annexureData['applicationDetail']['authorize_designation']); ?>

                                </div>
                                <div class="col-md-4">
                                    <label for="">Signatory Socument:</label>
                                    <?php if(($annexureData['applicationDetail']['signatory_document'] ?? '')!=null): ?>
                                            <a target="_blank"
                                                href="<?php echo e(URL::to($attchmentBaseUrl.$annexureData['applicationDetail']['signatory_document'])); ?>"
                                                class="document text-primary">View</a><?php else: ?> No <?php endif; ?>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <table class="table table-bordered">
                                        ...
                                        <?php $__currentLoopData = $annexureData['applied_pvmodels']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $pvmodels): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                    ...
                    <tr>
                        ...
                        <th>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <?php echo e($annexureData['applicationDetail']['manufacturing_capacity']); ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="row">
                                <div class="col-md-6">
                                    <?php if($annexureData['applicationDetail']['enlisted_almm']=='1'): ?>
                                    <label for="">Yes</label>
                                    <?php else: ?>
                                    <label for="">No</label>
                                    <?php endif; ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <?php echo e($annexureData['applicationDetail']['no_enlisted_pvmodel']); ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <?php echo e($annexureData['applicationDetail']['total_pv_capacity']); ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <?php echo e($annexureData['applicationDetail']['validity_from']); ?>

                                </div>

                                <div class="col-md-6">
                                    <label for="">to:</label>
                                    <?php echo e($annexureData['applicationDetail']['validity_to']); ?>
                        ...
                        <td>
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <?php echo e($annexureData['applicationDetail']['application_fees']); ?>

                                </div>
                                <div class="col-md-6">
                                    <label for="">Inspection Fees:</label>
                                    <?php echo e($annexureData['applicationDetail']['inspection_fees']); ?>

                                </div>

                                <div class="col-md-6">
                                    <label for="">Total Amount Paid:</label>
                                    <?php echo e($annexureData['applicationDetail']['total_amount']); ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <?php echo e($annexureData['applicationDetail']['payment_date']); ?>

                                </div>
                                <div style="clear:both"></div>
                                <div class="col-md-6">
                                    <label for="">UTR/reference No:</label>
                                    <?php echo e($annexureData['applicationDetail']['utn_no']); ?>

                                </div>
                                <div class="col-md-6">

                                    <label for="">Mode of Payment:</label>
                                    <?php echo e($annexureData['applicationDetail']['payment_mode']); ?>
                    ...
                    <tr>
                        ...
                        <td class="text-primary">
                            <?php if($annexureData['applicationDetail']['inspection_date']!=NULL): ?>
                            <?php echo e(date('d-M-Y', strtotime($annexureData['applicationDetail']['inspection_date']))); ?>
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                            ...
                            <div class="accordion-body" style="background-color: #d4d4d4;">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody class="annexure1_div">
                                        ...
                                        <?php $__currentLoopData = $annexureData['annexure1']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $annexureData['annexure1_sub2']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $annexure1_sub2_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $j=0; ?>
                                        <?php $__currentLoopData = $annexureData['annexure1_sub2']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $annexureData['annexure1_sub3']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $annexure1_sub3_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tbody>
                                    ...
                                    <?php $b=0; ?>
                                    <?php $__currentLoopData = $annexureData['annexure1_sub4']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data_4): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <table class="table table-bordered text-center">
                                ...
                                <tbody>
                                    ...
                                    <?php $c=0; ?>
                                    <?php $__currentLoopData = $annexureData['annexure1_sub5']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data_5): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <table class="table table-bordered text-center">
                                ...
                                <tbody>
                                    ...
                                    <?php $d=0; ?>
                                    <?php $__currentLoopData = $annexureData['annexure1_sub6']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data_6): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                            ...
                            <div class="accordion-body" style="background-color: #d4d4d4;">
                                ...
                                <table class="table table-bordered text-center">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $annexureData['annexure2_aryData']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e($loop->iteration); ?></td>
                                            <td><?php echo e($data->module_type); ?></td>
                                            <td><?php echo e($data->model_code); ?></td>
                        ...
                        <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                            ...
                            <div class="accordion-body" style="background-color: #d4d4d4;">
                                ...
                                <table class="table table-bordered text-center">
                                    ...
                                    <tbody>
                                        <?php $j = 1 ?>
                                        <?php $__currentLoopData = $annexureData['annexure3']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub_annex_1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <table class="table table-bordered text-center">
                                    ...
                                    <tbody>
                                        <?php $i = 1 ?>
                                        <?php $__currentLoopData = $annexureData['annexure3']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub_annex_2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="accordion-body" style="background-color: #d4d4d4;">
                                ...
                                <table class="table table-bordered text-center">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $annexureData['annexure4']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $annexureData['annexure4_sub3']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td>Sun Simulator</td>
                                            <td><?php echo e($loop->iteration); ?></td>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $i=$j=0; ?>
                                        <?php $__currentLoopData = $annexureData['annexure4_sub4']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $annexureData['annexure4_sub5']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e($loop->iteration); ?></td>
                        ...
                        <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive"
                            ...
                            <div class="accordion-body" style="background-color: #d4d4d4;">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo e(\App\Models\Annexure5::getFinancialDataadmin($annexureData['applicationDetail']['id'],$annexureData['applicationDetail']['user_id'],$name,$current_financial_year)); ?>

                                            </td>
                                            <td><?php echo e(\App\Models\Annexure5::getFinancialDataadmin($annexureData['applicationDetail']['id'],$annexureData['applicationDetail']['user_id'],$name,$last_financial_year)); ?>

                                            </td>
                                            <td><?php echo e(\App\Models\Annexure5::getFinancialDataadmin($annexureData['applicationDetail']['id'],$annexureData['applicationDetail']['user_id'],$name,$lasttolast_financial_year)); ?>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $annexureData['annexure5_appData']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e($loop->iteration); ?></td>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $annexureData['annexure5_lfyappData']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e($loop->iteration); ?></td>
                                            <td><?php echo e($data->month); ?></td>
                                            <td><?php echo e($data->module_sale); ?></td>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $annexureData['annexure5_ltlfyappData']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e($loop->iteration); ?></td>
                                            <td><?php echo e($data->month); ?></td>
                                            <td><?php echo e($data->module_sale); ?></td>
                            ...
                            <div class="accordion-body" style="background-color: #d4d4d4;">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $annexureData['annexure6']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $annexure6_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div id="collapseSeven" class="accordion-collapse collapse" aria-labelledby="headingSeven"
                            ...
                            <div class="accordion-body" style="background-color: #d4d4d4;">
                                <table class="table table-bordered">
                                    <tr>
                                        <th>
                                            <?php if(isset($annexureData['applicationDetail']) && $annexureData['applicationDetail']['annexure7']!=null): ?>
                                            <a href="<?php echo e(URL::to($docBaseUrl.$annexureData['applicationDetail']['annexure7'])); ?>"
                        ...
                        <div id="collapseEight" class="accordion-collapse collapse" aria-labelledby="headingEight"
                            ...
                            <div class="accordion-body" style="background-color: #d4d4d4;">
                                <table class="table table-bordered">
                                    <tr>
                                        <th>
                                            <?php if(isset($annexureData['applicationDetail']) && $annexureData['applicationDetail']['annexure8']!=null): ?>
                                            <a href="<?php echo e(URL::to($docBaseUrl.$annexureData['applicationDetail']['annexure8'])); ?>"
                                                style="margin-top: -8px;display: block;" target="_blank">View
                                                uploaded Annexure
                                            </a>
                                            <?php endif; ?>
                            ...
                            <div class="accordion-body" style="background-color: #d4d4d4;">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if(($annexureData['applicationDetail']['attc_incorporation_cerificate'] ?? '')!=null): ?>
                                            <a target="_blank"
                                                href="<?php echo e(URL::to($attchmentBaseUrl.$annexureData['applicationDetail']['attc_incorporation_cerificate'])); ?>"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if(($annexureData['applicationDetail']['attc_application_inspection_payment'] ?? '')!=null): ?>
                                            <a target="_blank"
                                                href="<?php echo e(URL::to($attchmentBaseUrl.$annexureData['applicationDetail']['attc_application_inspection_payment'])); ?>"
                                                class="document">Attachment No. 2</a><?php else: ?> No <?php endif; ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th> 3</th>
                                        ...
                                        <td>
                                            <?php if(($annexureData['applicationDetail']['attc_enlisted_module_datalist'] ?? '')!=null): ?>
                                            <a target="_blank"
                                                href="<?php echo e(URL::to($attchmentBaseUrl.$annexureData['applicationDetail']['attc_enlisted_module_datalist'])); ?>"
                                                class="document">Attachment No. 3</a><?php else: ?> No <?php endif; ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th> 4</th>
                                        ...
                                        <td>
                                            <?php if(($annexureData['applicationDetail']['attc_solar_cell_datalist'] ?? '')!=null): ?>
                                            <a target="_blank"
                                                href="<?php echo e(URL::to($attchmentBaseUrl.$annexureData['applicationDetail']['attc_solar_cell_datalist'])); ?>"
                                                class="document">Attachment No. 4</a><?php else: ?> No <?php endif; ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th> 5</th>
                                        ...
                                        <td>
                                            <?php if(($annexureData['applicationDetail']['attc_bom_details'] ?? '')!=null): ?>
                                            <a target="_blank"
                                                href="<?php echo e(URL::to($attchmentBaseUrl.$annexureData['applicationDetail']['attc_bom_details'])); ?>"
                                                class="document">Attachment No. 5</a><?php else: ?> No <?php endif; ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th> 6</th>
                                        ...
                                        <td>
                                            <?php if(($annexureData['applicationDetail']['attc_bis_certificate'] ?? '')!=null): ?>
                                            <a target="_blank"
                                                href="<?php echo e(URL::to($attchmentBaseUrl.$annexureData['applicationDetail']['attc_bis_certificate'])); ?>"
                                                class="document">Attachment No. 6</a><?php else: ?> No <?php endif; ?>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if(($annexureData['applicationDetail']['attc_accreditation_certificate'] ?? '')!=null): ?>
                                            <a target="_blank"
                                                href="<?php echo e(URL::to($attchmentBaseUrl.$annexureData['applicationDetail']['attc_accreditation_certificate'])); ?>"
                                                class="document">Attachment No. 7</a><?php else: ?> No <?php endif; ?>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if(($annexureData['applicationDetail']['attc_calibration_report_sun_simulator'] ??
                                            '')!=null): ?>
                                            <a target="_blank"
                                                href="<?php echo e(URL::to($attchmentBaseUrl.$annexureData['applicationDetail']['attc_calibration_report_sun_simulator'])); ?>"
                                                class="document">Attachment No. 8</a><?php else: ?> No <?php endif; ?>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if(($annexureData['applicationDetail']['attc_iso_certificate'] ?? '')!=null): ?>
                                            <a target="_blank"
                                                href="<?php echo e(URL::to($attchmentBaseUrl.$annexureData['applicationDetail']['attc_iso_certificate'])); ?>"
                                                class="document">Attachment No. 9</a><?php else: ?> No <?php endif; ?>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if(($annexureData['applicationDetail']['attc_balance_sheet_last_years'] ?? '')!=null): ?>
                                            <a target="_blank"
                                                href="<?php echo e(URL::to($attchmentBaseUrl.$annexureData['applicationDetail']['attc_balance_sheet_last_years'])); ?>"
                                                class="document">Attachment No. 10</a><?php else: ?> No <?php endif; ?>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href=""><?php if(($annexureData['applicationDetail']['attc_trademark_certificate'] ?? '')!=null): ?>
                                                <small><a target="_blank"
                                                        href="<?php echo e(URL::to($docBaseUrl.$annexureData['applicationDetail']['attc_trademark_certificate'])); ?>"
                                    ...
                                    <tr>
                                        ...
                                        <td><a href=""><?php if(($annexureData['applicationDetail']['attc_bis_lab_report'] ?? '')!=null): ?>
                                                <small><a target="_blank"
                                                        href="<?php echo e(URL::to($docBaseUrl.$annexureData['applicationDetail']['attc_bis_lab_report'])); ?>"
...
<?php echo $__env->make('layouts.masters.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\almm\resources\views/backend/user/form/view-applications.blade.php ENDPATH**/ ?>