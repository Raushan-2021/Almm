...
<div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="box-body">
                            ...
                            <?php endif; ?>
                            <form action="<?php echo e(URL::to('/users/existing-annexure-one')); ?>" method="POST"
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?php echo e(URL::to('users/existing-annexure-one/'.$data->application_id.'/'.$data->id)); ?>"
                                    ...
                                    <tr>
                                        <th colspan="9">
                                            ...
                                            <a href="<?php echo e(URL::to('users/existing-application-step2/'.$application_id)); ?>"
    ...
    <?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.masters.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\almm\resources\views/backend/user/existingmodel/annexureOne/existingannexure1.blade.php ENDPATH**/ ?>