                                                    ...
                                                    <table class="table">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <?php if(($annexuredata->doc_certificate ?? '')!=null): ?>
                                                                <input type="hidden" name="old_bis_certificate" id="">
                                                                <small><a target="_blank"
                                                                        href="<?php echo e(URL::to($docBaseUrl.$annexuredata->doc_certificate)); ?>"
                                                                        class="document">View Certificate</a></small><?php endif; ?>
                                                            </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <?php if(($annexuredata->nabl_certificate ?? '')!=null): ?>
                            ...
                            <table class="table table-bordered text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php if(($sub_annex_1->doc_certificate ?? '')!=null): ?>
                                                <small><a target="_blank"
                                                        href="<?php echo e(URL::to($docBaseUrl.$sub_annex_1->doc_certificate)); ?>"
                                                        class="document text-primary"><i class="bi bi-file-pdf fa-2x text-danger"></i></a></small><?php endif; ?></td>
                                        <td> <a
                            ...
                            <table class="table table-bordered text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php if(($sub_annex_2->doc_certificate ?? '')!=null): ?>
                                                <small><a target="_blank"
                                                        href="<?php echo e(URL::to($docBaseUrl.$sub_annex_2->doc_certificate)); ?>"
                                                        class="document text-primary"><i class="bi bi-file-pdf fa-2x text-danger"></i></a></small><?php endif; ?></td>
                                        </td>
                                        <td> <a
...
<?php echo $__env->make('layouts.masters.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\almm\resources\views/backend/user/form/annexureThree/annexureThree.blade.php ENDPATH**/ ?>