    ...
    <div class="box-body">
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <hr>
                <blockquote>
                    <?php if($annexureData['applicationDetail']['forward_status']=='mnre'): ?>
                    <tr>
                        <td colspan="1"></td>
        ...
        <div class="modal-content">
            ...
            <form action="<?php echo e(url('mnre/forwardto')); ?>" method="POST" autocomplete="off">
                ...
                <div class="modal-body">
                    <input type="hidden" name="id" value="<?php echo e($annexureData['applicationDetail']['id']); ?>">
...
<?php echo $__env->make('layouts.masters.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xamp\htdocs\ALMM\resources\views/backend/mnre/view-applications.blade.php ENDPATH**/ ?>