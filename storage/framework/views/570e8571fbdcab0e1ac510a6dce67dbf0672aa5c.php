            ...
            <form action="" method="POST" id="installationRejectionForm">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="rejection_reason"><?php echo e(__('What are the reasons of system rejection ?')); ?></label>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="" method="POST" id="installationModificationForm">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="modifications"><?php echo e(__('What modifications need to system ?')); ?></label>
...
<?php /**PATH C:\xampp\htdocs\almm\resources\views/layouts/partials/backend/_modals.blade.php ENDPATH**/ ?>