...
<div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="box-body">
                            ...
                            <?php endif; ?>
                            <form action="<?php echo e(URL::to('/users/annexureone')); ?>" method="POST"
    ...
    <?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.masters.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\almm\resources\views/backend/user/existingmodel/annexureOne/annexure1.blade.php ENDPATH**/ ?>