                ...
                <table id="stakeHoldersTable" class="table table-bordered" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php if($application->application_type=='1'): ?>
                                New Application
                            ...
                            <td><?php if($application->final_submission == '0'): ?>
                                <a href="<?php echo e(url('users/new-application/'.$application->id)); ?>"><i
                                        class="fa fa-edit"></i></a>
                                <?php else: ?>
                                <a href="<?php echo e(url('users/view-application/'.base64_encode($application->id))); ?>">View</a> |
...
<?php echo $__env->make('layouts.masters.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xamp\htdocs\ALMM\resources\views/backend/user/userApplications.blade.php ENDPATH**/ ?>