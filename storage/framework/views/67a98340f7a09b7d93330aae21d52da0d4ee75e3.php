        ...
        <div class="row pt-5 pb-1">
            <div class="col-md-12 col-lg-4 img-fluid tab_scrn animatedParent">
                <div class="animated fadeInDownShort go">
                    <img src="<?php echo e(URL::asset('public/frontend/images/mnre_logo.png')); ?>"
        ...
        <div class="row pt-3 ">
            <div class="col-md-12">
                ...
                <p>Website Content Managed by Ministry of New and Renewable Energy <br>Designed, Developed and Hosted by
                    <span>National Informatics Centre (NIC)</span></p>
            </div>
        </div>
    </div>
</section>
...
<?php /**PATH C:\xampp\htdocs\almm\resources\views/frontend/includes/footer.blade.php ENDPATH**/ ?>