...
<html lang="en">
    ...
    <head>
        ...
        <script src="{{ URL::asset('public/frontend/js/bootstrap.bundle.min.js') }}"></script>
        <link rel="stylesheet" href="{{ URL::asset('public/frontend/css/animations.css') }}" />
        <script src="https://code.jquery.com/jquery-3.2.1.min.js"></script>


        <link rel="icon" type="image/png" sizes="32x32" href="{{ URL::asset('public/frontend/images/favicon.png') }}">
        <link rel="icon" type="image/png" sizes="16x16" href="{{ URL::asset('public/frontend/images/favicon.png') }}">
    </head>
                ...
                <div class="row top_header pt-2 pb-2">
                    ...
                    <div class="col-md-3 rightSide nav justify-content-end">
                        <a class="hvr-hang" href=""><img
                                src="{{ URL::asset('public/frontend/images/meta_fb.png') }}"></a>
                        <a class="hvr-hang" href=""><img
                                src="{{ URL::asset('public/frontend/images/twitter.png') }}"></a>
                        <a class="hvr-hang" href=""><img
                                src="{{ URL::asset('public/frontend/images/linkedin.png') }}"></a>
                        <a class="hvr-hang" href=""><img
                                src="{{ URL::asset('public/frontend/images/youtube.png') }}"></a>
                        <a class="hvr-hang" href=""><img
                                src="{{ URL::asset('public/frontend/images/instagram.png') }}"></a>
                    </div>
                </div>
        ...
        <section>
            <nav id="stick_nav" class="navbar navbar-expand-lg  navbar-light bg-light bgWhite rounded ">
                ...
                <div class="container">
                    ...
                    <a class="navbar-brand" href=""><img src="{{ URL::asset('public/frontend/images/ALMM_logo.png') }}"
                            style="height: 60px;">
                        <img src="{{ URL::asset('public/frontend/images/azdi_ka_mohtsv.png') }}" style="height: 60px;">
                    </a>
