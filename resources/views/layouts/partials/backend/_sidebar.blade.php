<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            ...
            <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                ...
                <!-- <li>
                    <a href="{{URL::to('/'.Auth::getDefaultDriver().'/mnre-user-list')}}">
                        <i class="bi bi-circle"></i><span>MNRE Users</span>
                    </a>
                </li> -->
                <li>
                    <a href="{{URL::to('/'.Auth::getDefaultDriver().'/manufaturer-user-list')}}">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="{{URL::to('/'.Auth::getDefaultDriver().'/manufaturer-user-list')}}">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="{{URL::to('/'.Auth::getDefaultDriver().'/applications-list')}}">
        ...
        <li class="nav-item">
            ...
            <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li>
                    <a href="{{URL::to('/'.Auth::getDefaultDriver().'/applications-list')}}">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="{{URL::to('/'.Auth::getDefaultDriver().'/audit-trail')}}">
                <i class="bi bi-clipboard2-check"></i>
        ...
        <li class="nav-item">
            ...
            <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li><a href="#"><i class="bi bi-circle"></i>Help Documents</a></li>
                <li><a href="#"><i class="bi bi-circle"></i>Annexures</a></li>
                <li><a href="{{URL::to('/'.Auth::getDefaultDriver().'/application-fee-master')}}"><i
                            class="bi bi-circle"></i>Fee details</a></li>
                <li><a href="#"><i class="bi bi-circle"></i>Approved lists I & II</a></li>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="{{URL::to('/users/module-master')}}">
                <i class="bi bi-boxes"></i>
        ...
        <li class="nav-item">
            ...
            <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li><a href="{{URL::to('/users/user-applications')}}"><i class="bi bi-circle"></i>My
                        Application</a></li>
                <li><a href="{{URL::to('/users/new-application')}}"><i class="bi bi-circle"></i>New
                        Application</a></li>
                <li><a href="{{URL::to('/users/select-exising-application')}}"><i class="bi bi-circle"></i>PV
        ...
        @if (Auth::guard('mnre')->check() || Auth::guard('manufaturer_users')->check())
        <li class="nav-item">
            <a class="nav-link collapsed" href="{{URL::to('/'.Auth::getDefaultDriver().'/system-maintenance')}}">
    ...
    <a href="https://www.nic.in/"><img class="nicLogo" src="{{URL::asset('images/footerNIC.png')}}" width="100%"></a>
</aside>