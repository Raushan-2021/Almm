                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="box-body">
                            ...
                            @endforeach
                            @endif
                            <form action="{{URL::to('/users/annexure-one')}}" method="POST"
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{URL::to('users/annexure-one/'.$data->application_id.'/'.$data->id)}}"
                                    ...
                                    <tr>
                                        <th colspan="9">
                                            ...
                                            @endif
                                            <a href="{{URL::to('users/new-application-step2/'.$application_id)}}"
