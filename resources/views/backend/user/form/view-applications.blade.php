...
@section('content')
@section('title', 'Applications Detail : '.$annexureData['applicationDetail']['application_no'])
...
<div class="box box-primary">
    <div class="box-body">
        <div class="row">
            ...
            <div class="col-md-12">
                <a href="{{url('/users/user-applications')}}" class="btn btn-warning" style="float:right">Back</a>
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <th>
                            @if($annexureData['applicationDetail']['application_type']==1)
                            <i>New Application</i>
                            @elseif($annexureData['applicationDetail']['application_type']==2)
                            PV Model Addition at
                            the existing manufacturing facility>
                            @elseif($annexureData['applicationDetail']['application_type']==3)
                            Application for new
                            manufacturing facility
                            @elseif($annexureData['applicationDetail']['application_type']==4)
                            Renewal
                            @elseif($annexureData['applicationDetail']['application_type']==5)
                            Co-ALMM
                            @endif
                        </th>
                    </tr>
                    <tr>
                        ...
                        <th>
                            <div class="row">
                                <div class="col-md-6">
                                    {{$annexureData['applicationDetail']['manufacturer_name']}}
                                </div>
                                <!-- <div class="col-md-6">
                                                <div class="col-md-3">
                    ...
                    <tr>
                        ...
                        <th>
                            <div class="row">
                                <div class="col-md-4">
                                    {{$annexureData['applicationDetail']['manufacturer_brand_name']}}
                                ...
                                <div class="col-md-8">
                                    <img src="{{url('storage/systems/Logo/'.$annexureData['applicationDetail']['manufacturer_brand_logo'])}}"
                                        width="100">
                                </div>
                    ...
                    <tr>
                        ...
                        <th>
                            ...
                            {{$annexureData['applicationDetail']['register_office_address']}}
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="phone">Phone:</label>
                                    {{$annexureData['applicationDetail']['register_office_phone']}}
                                </div>

                                <div class="col-md-6">
                                    <label for="email">Email:</label>
                                    {{$annexureData['applicationDetail']['register_office_email']}}
                                </div>
                            </div>
                    ...
                    <tr>
                        ...
                        <th>
                            <label for="">Address:</label>
                            {{$annexureData['applicationDetail']['com_address']}}
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="phone">Phone:</label>
                                    {{$annexureData['applicationDetail']['com_phone']}}
                                </div>
                                <div class="col-md-6">
                                    <label for="email">Email:</label>
                                    {{$annexureData['applicationDetail']['com_email']}}
                                </div>
                            </div>
                    ...
                    <tr>
                        ...
                        <th>
                            {{$annexureData['applicationDetail']['plant_address']}}
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="phone">Phone:</label>
                                    {{$annexureData['applicationDetail']['plant_phone']}}
                                </div>
                                <div class="col-md-6"><label for="email">Email:</label>
                                    {{$annexureData['applicationDetail']['plant_email']}}
                                </div>
                                <div class="col-md-6">
                                    <label for="">Latitude:</label>
                                    {{$annexureData['applicationDetail']['plant_latitude']}}
                                </div>
                                <div class="col-md-6">
                                    <label for="Longitude">Longitude:</label>
                                    {{$annexureData['applicationDetail']['plant_longitude']}}
                                </div>
                            </div>
                        ...
                        <td>
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    {{$annexureData['applicationDetail']['existing_plant_india']}}
                                </div>
                                <div class="col-md-6">
                                    <label for="">No. of Manufacturing plant out of India:</label>
                                    {{$annexureData['applicationDetail']['existing_plant_outindia']}}
                                </div>
                            </div>
                        ...
                        <td>
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    {{$annexureData['applicationDetail']['contact_person_name']}}
                                </div>
                                <div class="col-md-6">
                                    <label for="">Designation:</label>
                                    {{$annexureData['applicationDetail']['person_designation']}}
                                </div>

                                <div class="col-md-6">
                                    <label for="">Phone No:</label>
                                    {{$annexureData['applicationDetail']['person_contact_no']}}
                                </div>

                                <div class="col-md-6">
                                    <label for="">E-mail:</label>
                                    {{$annexureData['applicationDetail']['person_email']}}
                                </div>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="col-md-4">
                                    <label for="">Name:</label>
                                    {{$annexureData['applicationDetail']['authorize_name']}}
                                </div>

                                <div class="col-md-4">
                                    <label for="">Designation:</label>
                                    {{$annexureData['applicationDetail']['authorize_designation']}}
                                </div>
                                <div class="col-md-4">
                                    <label for="">Signatory Socument:</label>
                                    @if(($annexureData['applicationDetail']['signatory_document'] ?? '')!=null)
                                            <a target="_blank"
                                                href="{{URL::to($attchmentBaseUrl.$annexureData['applicationDetail']['signatory_document'])}}"
                                                class="document text-primary">View</a>@else No @endif
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <table class="table table-bordered">
                                        ...
                                        @foreach ($annexureData['applied_pvmodels'] as $key => $pvmodels)
                                        <tr>
                                            <td>{{$key+1}}</td>
                    ...
                    <tr>
                        ...
                        <th>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    {{$annexureData['applicationDetail']['manufacturing_capacity']}}
                                </div>
                            </div>
                        </th>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div class="row">
                                <div class="col-md-6">
                                    @if($annexureData['applicationDetail']['enlisted_almm']=='1')
                                    <label for="">Yes</label>
                                    @else
                                    <label for="">No</label>
                                    @endif
                                ...
                                <div class="col-md-6">
                                    ...
                                    {{$annexureData['applicationDetail']['no_enlisted_pvmodel']}}
                                </div>
                                @endif

                                <div class="col-md-6">
                                    <label for="">Total PV Module Manufacturing Capacity (MW/year):</label>
                                    {{$annexureData['applicationDetail']['total_pv_capacity']}}
                                </div>
                                <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    ...
                                    {{$annexureData['applicationDetail']['validity_from']}}
                                </div>

                                <div class="col-md-6">
                                    <label for="">to:</label>
                                    {{$annexureData['applicationDetail']['validity_to']}}
                                </div>
                            </div>
                        </td>
                    </tr>
                        ...
                        <td>
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    {{$annexureData['applicationDetail']['application_fees']}}
                                </div>
                                <div class="col-md-6">
                                    <label for="">Inspection Fees:</label>
                                    {{$annexureData['applicationDetail']['inspection_fees']}}
                                </div>

                                <div class="col-md-6">
                                    <label for="">Total Amount Paid:</label>
                                    {{$annexureData['applicationDetail']['total_amount']}}
                                </div>


                                <div class="col-md-6">
                                    <label for="">Payment Date:</label>
                                    {{$annexureData['applicationDetail']['payment_date']}}
                                </div>
                                <div style="clear:both"></div>
                                <div class="col-md-6">
                                    <label for="">UTR/reference No:</label>
                                    {{$annexureData['applicationDetail']['utn_no']}}
                                </div>
                                <div class="col-md-6">

                                    <label for="">Mode of Payment:</label>
                                    {{$annexureData['applicationDetail']['payment_mode']}}
                    ...
                    <tr>
                        ...
                        <td class="text-primary">
                            @if($annexureData['applicationDetail']['inspection_date']!=NULL)
                            {{ date('d-M-Y', strtotime($annexureData['applicationDetail']['inspection_date'])) }}
                            @else
                            Not Mentioned
                            @endif
                        </td>
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                            ...
                            <div class="accordion-body" style="background-color: #d4d4d4;">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody class="annexure1_div">
                                        ...
                                        @foreach($annexureData['annexure1'] as $data)
                                        <tr>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($annexureData['annexure1_sub2'] as $annexure1_sub2_data)
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        @php $j=0; @endphp
                                        @foreach($annexureData['annexure1_sub2'] as $data)
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($annexureData['annexure1_sub3'] as $annexure1_sub3_data)
                                ...
                                <tbody>
                                    ...
                                    @php $b=0; @endphp
                                    @foreach($annexureData['annexure1_sub4'] as $data_4)
                            ...
                            <table class="table table-bordered text-center">
                                ...
                                <tbody>
                                    ...
                                    @php $c=0; @endphp
                                    @foreach($annexureData['annexure1_sub5'] as $data_5)
                            ...
                            <table class="table table-bordered text-center">
                                ...
                                <tbody>
                                    ...
                                    @php $d=0; @endphp
                                    @foreach($annexureData['annexure1_sub6'] as $data_6)
                        ...
                        <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                            ...
                            <div class="accordion-body" style="background-color: #d4d4d4;">
                                ...
                                <table class="table table-bordered text-center">
                                    ...
                                    <tbody>
                                        @foreach($annexureData['annexure2_aryData'] as $data)
                                        <tr>
                                            <td>{{$loop->iteration}}</td>
                                            <td>{{$data->module_type}}</td>
                                            <td>{{$data->model_code}}</td>
                        ...
                        <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                            ...
                            <div class="accordion-body" style="background-color: #d4d4d4;">
                                ...
                                <table class="table table-bordered text-center">
                                    ...
                                    <tbody>
                                        @php $j = 1 @endphp
                                        @foreach($annexureData['annexure3'] as $sub_annex_1)
                                ...
                                <table class="table table-bordered text-center">
                                    ...
                                    <tbody>
                                        @php $i = 1 @endphp
                                        @foreach($annexureData['annexure3'] as $sub_annex_2)
                            ...
                            <div class="accordion-body" style="background-color: #d4d4d4;">
                                ...
                                <table class="table table-bordered text-center">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($annexureData['annexure4'] as $data)
                                        <tr>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($annexureData['annexure4_sub3'] as $data)
                                        <tr>
                                            <td>Sun Simulator</td>
                                            <td>{{$loop->iteration}}</td>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        @php $i=$j=0; @endphp
                                        @foreach($annexureData['annexure4_sub4'] as $data)
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($annexureData['annexure4_sub5'] as $data)
                                        <tr>
                                            <td>{{$loop->iteration}}</td>
                        ...
                        <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive"
                            ...
                            <div class="accordion-body" style="background-color: #d4d4d4;">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{$loop->iteration}}</td>
                                            <td>{{$name}}</td>
                                            <td>{{\App\Models\Annexure5::getFinancialDataadmin($annexureData['applicationDetail']['id'],$annexureData['applicationDetail']['user_id'],$name,$current_financial_year)}}
                                            </td>
                                            <td>{{\App\Models\Annexure5::getFinancialDataadmin($annexureData['applicationDetail']['id'],$annexureData['applicationDetail']['user_id'],$name,$last_financial_year)}}
                                            </td>
                                            <td>{{\App\Models\Annexure5::getFinancialDataadmin($annexureData['applicationDetail']['id'],$annexureData['applicationDetail']['user_id'],$name,$lasttolast_financial_year)}}
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        @foreach($annexureData['annexure5_appData'] as $data)
                                        <tr>
                                            <td>{{$loop->iteration}}</td>
                                            <td>{{$data->month}}</td>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        @foreach($annexureData['annexure5_lfyappData'] as $data)
                                        <tr>
                                            <td>{{$loop->iteration}}</td>
                                            <td>{{$data->month}}</td>
                                            <td>{{$data->module_sale}}</td>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        @foreach($annexureData['annexure5_ltlfyappData'] as $data)
                                        <tr>
                                            <td>{{$loop->iteration}}</td>
                                            <td>{{$data->month}}</td>
                                            <td>{{$data->module_sale}}</td>
                            ...
                            <div class="accordion-body" style="background-color: #d4d4d4;">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($annexureData['annexure6'] as $annexure6_data)
                        ...
                        <div id="collapseSeven" class="accordion-collapse collapse" aria-labelledby="headingSeven"
                            ...
                            <div class="accordion-body" style="background-color: #d4d4d4;">
                                <table class="table table-bordered">
                                    <tr>
                                        <th>
                                            @if(isset($annexureData['applicationDetail']) && $annexureData['applicationDetail']['annexure7']!=null)
                                            <a href="{{URL::to($docBaseUrl.$annexureData['applicationDetail']['annexure7'])}}"
                        ...
                        <div id="collapseEight" class="accordion-collapse collapse" aria-labelledby="headingEight"
                            ...
                            <div class="accordion-body" style="background-color: #d4d4d4;">
                                <table class="table table-bordered">
                                    <tr>
                                        <th>
                                            @if(isset($annexureData['applicationDetail']) && $annexureData['applicationDetail']['annexure8']!=null)
                                            <a href="{{URL::to($docBaseUrl.$annexureData['applicationDetail']['annexure8'])}}"
                                                style="margin-top: -8px;display: block;" target="_blank">View
                                                uploaded Annexure
                                            </a>
                                            @endif
                            ...
                            <div class="accordion-body" style="background-color: #d4d4d4;">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if(($annexureData['applicationDetail']['attc_incorporation_cerificate'] ?? '')!=null)
                                            <a target="_blank"
                                                href="{{URL::to($attchmentBaseUrl.$annexureData['applicationDetail']['attc_incorporation_cerificate'])}}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if(($annexureData['applicationDetail']['attc_application_inspection_payment'] ?? '')!=null)
                                            <a target="_blank"
                                                href="{{URL::to($attchmentBaseUrl.$annexureData['applicationDetail']['attc_application_inspection_payment'])}}"
                                                class="document">Attachment No. 2</a>@else No @endif
                                        </td>
                                    </tr>
                                    <tr>
                                        <th> 3</th>
                                        ...
                                        <td>
                                            @if(($annexureData['applicationDetail']['attc_enlisted_module_datalist'] ?? '')!=null)
                                            <a target="_blank"
                                                href="{{URL::to($attchmentBaseUrl.$annexureData['applicationDetail']['attc_enlisted_module_datalist'])}}"
                                                class="document">Attachment No. 3</a>@else No @endif
                                        </td>
                                    </tr>
                                    <tr>
                                        <th> 4</th>
                                        ...
                                        <td>
                                            @if(($annexureData['applicationDetail']['attc_solar_cell_datalist'] ?? '')!=null)
                                            <a target="_blank"
                                                href="{{URL::to($attchmentBaseUrl.$annexureData['applicationDetail']['attc_solar_cell_datalist'])}}"
                                                class="document">Attachment No. 4</a>@else No @endif
                                        </td>
                                    </tr>
                                    <tr>
                                        <th> 5</th>
                                        ...
                                        <td>
                                            @if(($annexureData['applicationDetail']['attc_bom_details'] ?? '')!=null)
                                            <a target="_blank"
                                                href="{{URL::to($attchmentBaseUrl.$annexureData['applicationDetail']['attc_bom_details'])}}"
                                                class="document">Attachment No. 5</a>@else No @endif
                                        </td>
                                    </tr>
                                    <tr>
                                        <th> 6</th>
                                        ...
                                        <td>
                                            @if(($annexureData['applicationDetail']['attc_bis_certificate'] ?? '')!=null)
                                            <a target="_blank"
                                                href="{{URL::to($attchmentBaseUrl.$annexureData['applicationDetail']['attc_bis_certificate'])}}"
                                                class="document">Attachment No. 6</a>@else No @endif
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if(($annexureData['applicationDetail']['attc_accreditation_certificate'] ?? '')!=null)
                                            <a target="_blank"
                                                href="{{URL::to($attchmentBaseUrl.$annexureData['applicationDetail']['attc_accreditation_certificate'])}}"
                                                class="document">Attachment No. 7</a>@else No @endif
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if(($annexureData['applicationDetail']['attc_calibration_report_sun_simulator'] ??
                                            '')!=null)
                                            <a target="_blank"
                                                href="{{URL::to($attchmentBaseUrl.$annexureData['applicationDetail']['attc_calibration_report_sun_simulator'])}}"
                                                class="document">Attachment No. 8</a>@else No @endif
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if(($annexureData['applicationDetail']['attc_iso_certificate'] ?? '')!=null)
                                            <a target="_blank"
                                                href="{{URL::to($attchmentBaseUrl.$annexureData['applicationDetail']['attc_iso_certificate'])}}"
                                                class="document">Attachment No. 9</a>@else No @endif
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if(($annexureData['applicationDetail']['attc_balance_sheet_last_years'] ?? '')!=null)
                                            <a target="_blank"
                                                href="{{URL::to($attchmentBaseUrl.$annexureData['applicationDetail']['attc_balance_sheet_last_years'])}}"
                                                class="document">Attachment No. 10</a>@else No @endif
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="">@if(($annexureData['applicationDetail']['attc_trademark_certificate'] ?? '')!=null)
                                                <small><a target="_blank"
                                                        href="{{URL::to($docBaseUrl.$annexureData['applicationDetail']['attc_trademark_certificate'])}}"
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="">@if(($annexureData['applicationDetail']['attc_bis_lab_report'] ?? '')!=null)
                                                <small><a target="_blank"
                                                        href="{{URL::to($docBaseUrl.$annexureData['applicationDetail']['attc_bis_lab_report'])}}"
