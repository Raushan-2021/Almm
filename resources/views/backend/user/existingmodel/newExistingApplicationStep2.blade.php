            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="box-body">
                            <form action="{{URL::to('/users/existing-application-step2')}}" method="POST"
