                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="box-body">
                            ...
                            <form action="{{URL::to('/users/existing-application')}}" method="POST"
                                ...
                                <table class="table table-bordered">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <select name="country" id="country">
                                                        ...
                                                        <option value="{{$country->countrycd}}" @if(!Empty($appData->
                                    ...
                                    <tr>
                                        <th colspan="3">
                                            ...
                                            @if(isset($appData->id))
                                            <a href="{{ URL::to('users/existing-application-step2/'.$appData->id)}}"
