...
<div class="box box-primary">
    <div class="box-body">
        <div class="row">
            <div class="col-md-12">
                <a href="{{url('/nise/applications-list')}}" class="btn btn-warning" style="float:right">Back</a>
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <th>{{$applicationDetail['application_no']}}</th>
                    </tr>
                    <tr>
                ...
                <hr>
                <blockquote>
                    @if($applicationDetail['forward_status']=='nise')
                    <tr>
                        <td colspan="7">
...
<!-- <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ url('nise/forwardto') }}" method="POST" autocomplete="off">
                {{ csrf_field() }}
...
<div class="modal" id="scheduleInspection">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <!-- Modal body -->
            <form action="{{ url('nise/scheduleInspection')}}" method="POST" autocomplete="off" id="formId">
                @csrf
                <div class="modal-body">
                    <input type="hidden" name="application_id" value="{{$applicationDetail['id']}}">
                    <input type="hidden" name="user_id" value="{{$applicationDetail['user_id']}}">
                    <input type="hidden" name="proposedDate" id="proposedDate"
                        value="{{$applicationDetail['inspection_date']}}">

                    <div class="form-group">
                        <label for="forward_status" class="col-form-label">Manufature Proposed Inspection Date:</label>
                        @if($applicationDetail['inspection_date']!=NULL)
                        <strong
                            class="text-success">{{ date('d-M-Y', strtotime($applicationDetail['inspection_date'])) }}</strong>
                        @else
                        Not Mentioned
                        @endif
