...
<div class="box-body">
    <div class="box-body">
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" disabled class="form-control required" value="{{$installation->inspectionUniqueId ?? 'Not Generated'}}">
                    <input type="hidden" name="inspection_id" value="{{$installation->inspectionUniqueId}}">
            ...
            <div class="col-md-4">
                ...
                <label for="date">{{ __('Date of inspection') }} <span class="error">*</span></label>
                    <div class="input-group date">
                        ...
                        <input type="text" {{$editableInspector ?? ''}} class="form-control required datepicker" name="date" value="@if(!empty($installation->inspectionDate)) {{date('d-m-Y', strtotime($installation->inspectionDate))}} @endif" autocomplete="off">
                    </div>
                </div>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <select class="form-control" name="appropriate_location" {{$editableInspector ?? ''}}>
                        ...
                        <div class="col-md-3">
                            <select class="form-control" name="beneficiary_feeding_plant" {{$editableInspector ?? ''}}>
                                <option selected disabled>Select Option</option>
                        ...
                        <div class="col-md-3">
                            <select class="form-control" name="biogas_production_optimum_level" {{$editableInspector ?? ''}}>
                                <option selected disabled>Select Option</option>
                        ...
                        <div class="col-md-3">
                            <select class="form-control" name="plant_connected_to_pipeline" {{$editableInspector ?? ''}}>
                                <option selected disabled>Select Option</option>
                        ...
                        <div class="col-md-3">
                            <select class="form-control" name="biogas_used_at_kitchen" {{$editableInspector ?? ''}}>
                                <option selected disabled>Select Option</option>
                        ...
                        <div class="col-md-3">
                            <select class="form-control" name="optimum_quantity_of_biogas_slurry_produced" {{$editableInspector ?? ''}}>
                                <option selected disabled>Select Option</option>
                        ...
                        <div class="col-md-3">
                            <select class="form-control" name="slurry_used_for_agriculture_business" {{$editableInspector ?? ''}}>
                                <option selected disabled>Select Option</option>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="file" {{$editableInspector ?? ''}} class="form-control @if(empty($installation->pic_of_plant_with_family_member)) required @endif" name="pic_of_plant_with_family_member">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="file" {{$editableInspector ?? ''}} class="form-control @if(empty($installation->pic_of_stove_with_flame)) required @endif" name="pic_of_stove_with_flame">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" {{$editableInspector ?? ''}} name="recommendations" id="" cols="30" rows="5">{{$installation->recommendations ?? ''}}</textarea>
        </div>
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    <label for="approval">Approval</label>
                    <select class="form-control required" name="approval" id="approval" {{$editableInspector ?? ''}}>
        ...
        <div id="correctionDiv" style="display: none;">
            <div class="form-group">
                <label for="">Correction required</label>
                <textarea class="form-control" name="corrections" id="corrections" cols="30" rows="5"></textarea>
            </div>
        </div>
    </div>
    <div class="box-footer @if($editableInspector == 'disabled')) hidden @endif">
