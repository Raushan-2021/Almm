...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            <div class="box-body">
                <form action="{{URL::to('/state-implementing-agency/edit-profile')}}" id="editProfileForm" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control required" name="user_id" value="{{$user->state_implementing_agency_id}}" disabled>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
