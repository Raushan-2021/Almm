...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            <div class="box-body">
                <form action="{{URL::to('/installer/edit-profile')}}" id="editProfileForm" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control required" name="user_id" value="{{$user->installer_id}}" disabled>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control required" name="pincode" value="{{$user->pincode}}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="category">{{ __('Category') }} <span class="error">*</span></label>
                                <input type="text" class="form-control required" name="category" value="{{$user->category}}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
